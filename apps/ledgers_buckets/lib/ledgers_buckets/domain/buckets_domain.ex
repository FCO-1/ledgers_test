  ...
  alias LedgersBuckets.Schemas.Buckets.BucketForExpand
    ...
    def create_new_buckets_for_partitions(attrs, amount, list_buckets_ids) do
      ...
      if amount <= sum_from_buckets do
        ...
        Buckets.create_new_bucket_transaction_for_new_buckets(Map.merge(attrs, %{"amount" => amount}), amount, remain, list_buckets)
      else
    ...
    def check_avaliable_balance_for_ask_document(owner) do
      Buckets.check_avaliable_balance_for_ask_document(owner)
    end
