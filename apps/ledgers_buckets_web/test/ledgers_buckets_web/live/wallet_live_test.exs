defmodule LedgersBucketsWeb.WalletLiveTest do
  use LedgersBucketsWeb.ConnCase

  import Phoenix.LiveViewTest
  import LedgersBuckets.AccountBooksFixtures

  @create_attrs %{extras: %{}, name: "some name", node: "some node", path: "some path", state: "some state", weight: 42}
  @update_attrs %{extras: %{}, name: "some updated name", node: "some updated node", path: "some updated path", state: "some updated state", weight: 43}
  @invalid_attrs %{extras: nil, name: nil, node: nil, path: nil, state: nil,  weight: nil}
